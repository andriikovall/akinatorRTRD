(function(root, factory) {
    ...
    var supports = !!document.querySelector && !!root.addEventListener, // feature test
        ...
        openClass = "mdtoast--open",
        modalClass = "mdtoast--modal",
        mdtoast = function() {
        ...
        setAttributes = function(el, attrs) {
            ...
            var recursiveSet = function(at, set) {
                for (var prop in at) {
                    var a = at[prop];
                    if ((typeof a === 'object' && a !== null) && a.dataset === undefined && a[0] === undefined) { recursiveSet(a, set[prop]); } else { set[prop] = a; }
                }
            }
